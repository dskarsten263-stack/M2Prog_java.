...
function drawSanta(x, y, s = 1) {
  g.save();
  g.translate(x, y);
  g.scale(s, s);

  g.fillStyle = '#c1121f';
  g.fillRect(-20, 0, 40, 50);

  g.fillStyle = '#000000';
  g.fillRect(-20, 25, 40, 8);

  g.beginPath();
  g.fillStyle = '#ffddb3';
  g.arc(0, -15, 12, 0, Math.PI * 2);
  g.fill();

  g.beginPath();
  g.fillStyle = '#ffffff';
  g.arc(0, -10, 14, 0, Math.PI);
  g.fill();
...
function drawCard() {
  ...
  drawHouse(558, canvas.height - 140, 0.8);
  drawHouse(30, canvas.height - 140, 0.8);
  drawHouse(460, canvas.height - 140, 0.8);
  drawTree(300, canvas.height - 100, 1.1);
  drawTree(490, canvas.height - 100, 0.9);
  drawTree(130, canvas.height - 100, 0.9);
  drawTree(650, canvas.height - 100, 1.1);

  drawSanta(400, canvas.height - 110, 1.5);
